import { addArrow } from "../../src/js/controller/addArrow.js";
import { getRandomNumber } from "../../src/js/controller/utils.js";
// import { addArrow } from "../../src/js/controller/racingController.js";
...
describe("자동차 레이싱 테스트", () => {
  ...
  it("자동차가 전진했을 경우만 화살표가 나타나는지 확인한다. feat. 에뒈로우의 역설", () => {
